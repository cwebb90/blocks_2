    ...
    var GameScene = (function (_super) {
        ...
        GameScene.prototype.registerEvents = function () {
            ...
            document.onkeypress = function (e) {
                if (e.keyCode == 97) {
                    if (that.game.canMoveLeft())
                        that.game.currentShape.moveLeft();
                }
                else if (e.keyCode == 100) {
                    if (that.game.canMoveRight())
                        that.game.currentShape.moveRight();
                }
                else if (e.keyCode == 115) {
                    if (that.game.canMoveDown())
                        that.game.currentShape.moveDown();
                }
                    ...
                    that.game.mapLevel(that.game.levelmap);
                }
            };
        };
